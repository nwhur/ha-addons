...
- **데이터 파싱 주소 매핑 (2바이트씩):**
  ...
  - **[Address 13]** 실내 온도 (int16 파싱 후 10.0으로 나누어 소수점 1자리 실제 온도로 변환)
  - **[Address 14]** 실내 습도 (10.0으로 나누어 변환)
  - **[Address 16]** 실내 CO2 (정수 그대로 사용)
  - **[Address 17]** 실내 PM10
  - **[Address 18]** 실내 PM2.5
  - **[Address 20]** 외부 온도 (int16 파싱 후 10.0으로 나누기)
  - **[Address 21]** 외부 습도 (10.0으로 나누기)
